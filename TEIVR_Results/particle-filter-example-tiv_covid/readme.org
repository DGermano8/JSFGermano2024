...
** How do I run this on other versions of Python?

The following is not recommended, but might work if you are having
trouble with the recommended path.
...
#+begin_src sh
  ...
  pip install matplotlib numpy pandas plotnine pypfilt scipy statsmodels
  # Careful with these!
  pip install PyQt5
